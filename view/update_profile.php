...
$profile_id_u = \App\Session::get('profile_id');
...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES["app_signature"]["name"] != '') {
        ...
        if (!in_array($extension, $accepted_ext)) {
            ...
            $application_signature_upload = 1;
    ...
    if (
        ...
        $prev_number = $profile->getPreviousNmbr($profile_id_u);
        if ($_POST['mobile_1'] != $prev_number->user_name) {

            $number_taken = 1;
        } else if ($profile->checkDuplicateMailForUpdate($_POST['mail_1'], $profile_id_u)) {
            $mail_duplicate = 1;
        }
        ...
        // echo $prosper_error . "prosper error <br>";
            ...
            //get education history table  primary key
            $resEduId = $profile->getEducationHistId($profile_id_u);
            //get employment history table primary key
            $resEmpId = $profile->getEmploymentHistId($profile_id_u);

            //delete previous education field data
            $profile->deleteEducationHist($profile_id_u, $resEduId);
            //delete previous employment field data
            $profile->deleteEmploymentHist($profile_id_u, $resEmpId);


            $profile->set($_POST);
            //$profile->show_data();
            //$profile_id = $profile->insert_userProfile();
            $profile->update_userProfile($profile_id_u, $user_id);
            $profile->update_user($profile_id_u, $user_id);
            $profile->update_userAddress($profile_id_u, $user_id);
            $profile->insert_educationHistory($profile_id_u, $user_id);
            $profile->insert_employmentHistory($profile_id_u, $user_id);
            $profile->update_imcb_membership_info($profile_id_u, $user_id);
            $profile->update_member_client_reference_update($profile_id_u, $user_id);
            $profile->update_memberProsper($profile_id_u, $user_id);
            $profile->update_memberConsultingExperiencee($profile_id_u, $user_id);
...
//var_dump($user_id);
//var_dump($profile_id_u);

//transfer from top
$res = $profile->getprofileinfoByID($profile_id_u);
//var_dump("res", $res);
//echo $res->contact_category_type_id . "<br>";
$res_1 = $profile->getMembershipInfo($profile_id_u);
$res_edu = $profile->getEducationInfo($profile_id_u);
$res_client = $profile->getClientPre($profile_id_u);
$res_consult = $profile->getConsultingExp($profile_id_u);
$res_prosper = $profile->getProsper($profile_id_u);
$res_address = $profile->getAddress($profile_id_u);
$res_employ = $profile->getEmploymentHist($profile_id_u);
//cho $res_edu->institute_name . "<br>";
// var_dump($res_client);
// echo "<br>";
// var_dump($res_client[0]['client_name']);
//var_dump($res_consult);
//var_dump($res_prosper);
...
<body>
    ...
    ?>
        <div class="alert alert-success alert-dismissible">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <p>
                This number Can't change !!......

            </p>
        </div>
    <?php }
    if (isset($mail_duplicate)) {
    ?>
        <div class="alert alert-success alert-dismissible">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <p>
                This Mail Already Taken !!......
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row no_float mb-3">
                                        <div class="col-md-12 ">
                                            ...
                                            foreach ($row as $rows) {
                                                $i++;
                                            ?>
                                                <input class="has-error has-danger" type="radio" id="" name="member_type" value="<?php echo $rows['contact_category_type_id'] ?>" <?php if ($res->contact_category_type_id == $i) : ?> Checked <?php endif; ?> required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-4 ">
                                                <label>Name</label>
                                                <input class="form-control mandatory_field" name="name_1" type="text" placeholder="name" value="<?php echo $res->FullName ?>" required>
                                            </div>
                                            <div class="col-md-4  ">
                                                <label>Preferred Name</label>
                                                <input class="form-control" name="preferred_name" type="text" placeholder="preferred name" value="<?php echo $res->DisplayName ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Date of Birth</label>
                                                <input class="form-control" id="dob" type="date" name="dob" value="<?php echo $res->DateOfBirth ?>" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control" placeholder="company name" name="company_name" value="<?php echo $res_1->company_name ?>" type="text">
                                            </div>
                                            <div class="col-md-4">
                                                <label>No. of Employees </label>
                                                <input class="form-control" type="number" name="noe" placeholder="no. of employees" value="<?php echo $res_1->total_employees ?>"><br>
                                            </div>

                                            <div class="col-md-4">
                                                <label> Position Title </label>
                                                <input class="form-control" type="text" name="position_title" placeholder="position title" value="<?php echo $res->Title ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="business_address" placeholder="business_address" value="<?php echo $res_address[0]['Address'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Phone</label>
                                                <input class="form-control" type="tel" name="phone_1" placeholder="01234567890" value="<?php echo $res_address[0]['phone'] ?>" pattern="[0-9]{11}" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Fax</label>
                                                <input class="form-control" type="tel" name="fax_1" value="<?php echo $res_address[0]['fax'] ?>" placeholder="fax">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="private_address" placeholder="private Address" value="<?php echo $res_address[1]['Address'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Phone</label>
                                                <input class="form-control" type="tel" name="phone_2" placeholder="01234567890" value="<?php echo $res_address[1]['phone'] ?>" pattern="[0-9]{11}" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Fax</label>
                                                <input class="form-control" type="tel" name="fax_2" placeholder="fax" value="<?php echo $res_address[1]['fax'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-4 ">
                                                <label>Mobile</label>
                                                <input class="form-control" type="tel" name="mobile_1" placeholder="01234567890" pattern="[0-9]{11}" value="<?php echo $res->PrimaryMobile ?>" readonly="readonly" required>
                                            </div>
                                            <div class="col-md-3 ">
                                                <label>E-mail Address </label>
                                                <input class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" type="email" name="mail_1" placeholder="e-mail address" value="<?php echo $res->Email ?>" required>
                                            </div>
                                            <div class="col-md-5 lub">
                                                <label>Send Mail to</label>
                                                <div class="no_float">
                                                    <input type="radio" id="6" name="address_type" value="6" <?php if ($res_1->send_mail_option == "6") : ?> Checked <?php endif; ?> required>
                                                    <label>Business Address</label>

                                                    <input type="radio" id="7" name="address_type" value="7" <?php if ($res_1->send_mail_option == "7") : ?> Checked <?php endif; ?>>
                                                    <label>Private Address</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12 mt-10 expense-sidebar-left">
                                                <div class="single-item" id="single">
                                                    ...
                                                    <?php
                                                    $num_of_university = count($res_edu);
                                                    ...
                                                    ?>
                                                        <div class="row" id="item">
                                                            <div class="col-md-4">
                                                                <div class="form-group ">
                                                                    <input type="text" class="form-control" name="university[]" placeholder="university/college" value="<?php echo $row['institute_name']  ?>" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" step="any" name="qualification[]" id="itemUnitPrice1" class="form-control" placeholder="qualification obtained" value="<?php echo $row['degree_name'] ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-1">-->
                                                            <!--                                                        <div class="form-group">-->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input name="qual_year[]" type="number" id="remarks1" class="form-control" placeholder="year" pattern="[0-9]{4}" value="<?php echo $row['year'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input class="lab form-control" type="text" name="professional_body" placeholder="membership professional body" value="<?php echo $res_1->member_professional_body ?>">
                                        </div>
                                    </div>
                                    <br><br><br>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-8">
                                                ...
                                                <div class="no_float">
                                                    ...
                                                    <input type="radio" id="public" name="consultant_1" value="public_consultant" <?php if ($res_consult->consultant_option == "public_consultant") : ?> Checked <?php endif; ?> required>
                                                    <label>consultant in public practice </label>
                                                    <input type="radio" id="internal" name="consultant_1" value="international_consultant" <?php if ($res_consult->consultant_option == "international_consultant") : ?> Checked <?php endif; ?>>
                                                    <label>an internal consultant </label>
                                                    <input type="radio" id="academic" name="consultant_1" value="academic_consultant" <?php if ($res_consult->consultant_option == "academic_consultant") : ?> Checked <?php endif; ?>>
                                                    <label>an academic consultant</label>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label>I have spent</label>
                                                <input style="width:60%;" class="form-control" type="number" name="consultant_experience" placeholder="age" value="<?php echo $res_consult->consultant_experience ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <select name="consulting_month" class="form-control" required>
                                                            ...
                                                            <option style="font-weight:bold;" value="january" <?php if ($res_consult->consultant_month == "january") : ?> Selected <?php endif; ?>>january</option>
                                                            <option style="font-weight:bold;" value="february" <?php if ($res_consult->consultant_month == "february") : ?> Selected <?php endif; ?>>february</option>
                                                            <option style="font-weight:bold;" value="march" <?php if ($res_consult->consultant_month == "march") : ?> Selected <?php endif; ?>>march</option>
                                                            <option style="font-weight:bold;" value="april" <?php if ($res_consult->consultant_month == "april") : ?> Selected <?php endif; ?>>april</option>
                                                            <option style="font-weight:bold;" value="may" <?php if ($res_consult->consultant_month == "may") : ?> Selected <?php endif; ?>>may</option>
                                                            <option style="font-weight:bold;" value="june" <?php if ($res_consult->consultant_month == "june") : ?> Selected <?php endif; ?>>june</option>
                                                            <option style="font-weight:bold;" value="july" <?php if ($res_consult->consultant_month == "july") : ?> Selected <?php endif; ?>>july</option>
                                                            <option style="font-weight:bold;" value="august" <?php if ($res_consult->consultant_month == "august") : ?> Selected <?php endif; ?>>august</option>
                                                            <option style="font-weight:bold;" value="september" <?php if ($res_consult->consultant_month == "september") : ?> Selected <?php endif; ?>>september</option>
                                                            <option style="font-weight:bold;" value="october" <?php if ($res_consult->consultant_month == "october") : ?> Selected <?php endif; ?>>october</option>
                                                            <option style="font-weight:bold;" value="november" <?php if ($res_consult->consultant_month == "november") : ?> Selected <?php endif; ?>>november</option>
                                                            <option style="font-weight:bold;" value="december" <?php if ($res_consult->consultant_month == "december") : ?> Selected <?php endif; ?>>december</option>

                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input style="width:120%" class="form-control" id="year2" placeholder="year" type="number" name="consulting_year" pattern="[0-9]{4}" value="<?php echo $res_consult->consultant_year ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <textarea class="form-control" id="" name="major_specification" rows="1" cols="10" placeholder="major specialization areas"><?php echo $res_consult->major_specification ?></textarea>
                                    <label>I am applying for the membership of the Institute of Management Consultants Bangladesh because</label>
                                    <textarea class="form-control" id="" name="applying_reason" rows="1" cols="10" placeholder="applying reason"><?php echo $res_consult->applying_reason ?></textarea>
                                    </p>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12 mt-10 expense-sidebar-left">
                                                <div class="single-item" id="double">
                                                    ...
                                                    foreach ($res_employ as $row) {
                                                    ?>
                                                        <div class="row" id="item2">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" name="employer_j[]" placeholder="designation" value="<?php echo $row['employee_designation'] ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-2 hidden">-->
                                                            <!--                                                        -->
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group col-md-6">
                                                                        <select name="month_j1[]" class="form-control" required>
                                                                            <option style="font-weight:bold;" value="">month</option>
                                                                            <option style="font-weight:bold;" value="january" <?php if ($month[0] == "january") : ?> Selected <?php endif; ?>>january</option>
                                                                            <option style="font-weight:bold;" value="february" <?php if ($month[0] == "february") : ?> Selected <?php endif; ?>>february</option>
                                                                            <option style="font-weight:bold;" value="march" <?php if ($month[0] == "march") : ?> Selected <?php endif; ?>>march</option>
                                                                            <option style="font-weight:bold;" value="april" <?php if ($month[0] == "april") : ?> Selected <?php endif; ?>>april</option>
                                                                            <option style="font-weight:bold;" value="may" <?php if ($month[0] == "may") : ?> Selected <?php endif; ?>>may</option>
                                                                            <option style="font-weight:bold;" value="june" <?php if ($month[0] == "june") : ?> Selected <?php endif; ?>>june</option>
                                                                            <option style="font-weight:bold;" value="july" <?php if ($month[0] == "july") : ?> Selected <?php endif; ?>>july</option>
                                                                            <option style="font-weight:bold;" value="august" <?php if ($month[0] == "august") : ?> Selected <?php endif; ?>>august</option>
                                                                            <option style="font-weight:bold;" value="september" <?php if ($month[0] == "september") : ?> Selected <?php endif; ?>>september</option>
                                                                            <option style="font-weight:bold;" value="october" <?php if ($month[0] == "october") : ?> Selected <?php endif; ?>>october</option>
                                                                            <option style="font-weight:bold;" value="november" <?php if ($month[0] == "november") : ?> Selected <?php endif; ?>>november</option>
                                                                            <option style="font-weight:bold;" value="december" <?php if ($month[0] == "december") : ?> Selected <?php endif; ?>>december</option>

                                                                        </select>
                                                                        <!-- <input type="text" step="any" name="month_j1[]" id="itemUnitPrice-1" class="form-control" placeholder="month"> -->
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <input type="number" step="any" name="year_j1[]" id="itemUnitPrice-2" class="form-control" placeholder="year" pattern="[0-9]{4}" value="<?php echo $month[1]; ?>" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-1">-->
                                                            ...
                                                            <!--                                                    </div>-->
                                                            <?php
                                                            $temp_2 = $row['to_month_year'];

                                                            $month_2 = explode(",", $temp_2);
                                                            //print_r($month);
                                                            ?>
                                                            <div class="col-md-4">
                                                                <div class="col-md-12">
                                                                    <div class="form-group col-md-6">
                                                                        <select name="month_j2[]" class="form-control" required>
                                                                            <option style="font-weight:bold;" value="">month</option>
                                                                            <option style="font-weight:bold;" value="january" <?php if ($month_2[0] == "january") : ?> Selected <?php endif; ?>>january</option>
                                                                            <option style="font-weight:bold;" value="february" <?php if ($month_2[0] == "february") : ?> Selected <?php endif; ?>>february</option>
                                                                            <option style="font-weight:bold;" value="march" <?php if ($month_2[0] == "march") : ?> Selected <?php endif; ?>>march</option>
                                                                            <option style="font-weight:bold;" value="april" <?php if ($month_2[0] == "april") : ?> Selected <?php endif; ?>>april</option>
                                                                            <option style="font-weight:bold;" value="may" <?php if ($month_2[0] == "may") : ?> Selected <?php endif; ?>>may</option>
                                                                            <option style="font-weight:bold;" value="june" <?php if ($month_2[0] == "june") : ?> Selected <?php endif; ?>>june</option>
                                                                            <option style="font-weight:bold;" value="july" <?php if ($month_2[0] == "july") : ?> Selected <?php endif; ?>>july</option>
                                                                            <option style="font-weight:bold;" value="august" <?php if ($month_2[0] == "august") : ?> Selected <?php endif; ?>>august</option>
                                                                            <option style="font-weight:bold;" value="september" <?php if ($month_2[0] == "september") : ?> Selected <?php endif; ?>>september</option>
                                                                            <option style="font-weight:bold;" value="october" <?php if ($month_2[0] == "october") : ?> Selected <?php endif; ?>>october</option>
                                                                            <option style="font-weight:bold;" value="november" <?php if ($month_2[0] == "november") : ?> Selected <?php endif; ?>>november</option>
                                                                            <option style="font-weight:bold;" value="december" <?php if ($month_2[0] == "december") : ?> Selected <?php endif; ?>>december</option>

                                                                        </select>
                                                                        <!-- <input type="text" step="any" name="month_j2[]" id="itemUnitPrice-3" class="form-control" placeholder="month"> -->
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <input type="number" step="any" name="year_j2[]" id="itemUnitPrice1-4" class="form-control" placeholder="year" pattern="[0-9]{4}" value="<?php echo $month_2[1] ?>" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 form-group">
                                                                <textarea class="form-control" id="itemUnitPrice1-5" name="position_j[]" rows="1" cols="10" placeholder="position and summary of major duties" required><?php echo $row['about'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    <?php  } ?>
                                                    <div id="more-items"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="prosper" id="" placeholder="prosper" value="<?php echo $res_prosper->prosper ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" type="number" name="membership_no_1" placeholder="membership no" value="<?php echo $res_prosper->prosper_membership_no ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12 form-group">
                                                <label>Grade</label>
                                                <div class="col-md-5">
                                                    <input class="form-control" type="text" name="grade_1" placeholder="grade" value="<?php echo $res_prosper->prosper_grade ?>">
                                                </div>
                                                <label>Date</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" id="prosper_date" type="date" name="date_1" value="<?php echo $res_prosper->prosper_date ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="seconder" id="" placeholder="seconder" value="<?php echo $res_prosper->seconder ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <label class="">Membership No</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" type="number" name="membership_no_2" placeholder="membership no" value="<?php echo $res_prosper->seconder_membership_no ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12 form-group">
                                                <label>Grade</label>
                                                <div class="col-md-5">
                                                    <input class="form-control" type="text" name="grade_2" placeholder="grade" value="<?php echo $res_prosper->seconder_grade ?>">
                                                </div>
                                                <label>Date</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" name="date_2" id="seconder_date" type="date" placeholder="date" value="<?php echo $res_prosper->seconder_date ?>">
                                                ...
                                                <div class="col-md-12 mt-10 expense-sidebar-left">
                                                    <div class="single-item" id="triple form-group">
                                                        ...
                                                        <div class="row count" id="item">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" name="name_j[]" placeholder="name" value="<?php echo  $res_client[0]['client_name']; ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-2 hidden">-->
                                                            <!--                                                        -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" step="any" name="address_j[]" id="address1" class="form-control" placeholder="address" value="<?php echo $res_client[0]['client_address']; ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-1">-->
                                                            <!--                                                        <div class="form-group">-->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="tel" name="phone_j[]" id="phone1" class="form-control" placeholder="01234567890" pattern="[0-9]{11}" value="<?php echo $res_client[0]['client_phone']; ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row count" id="item">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" name="name_j[]" placeholder="name" value="<?php echo $res_client[1]['client_name']; ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-2 hidden">-->
                                                            <!--                                                        -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" step="any" name="address_j[]" id="address1" class="form-control" placeholder="address" value="<?php echo  $res_client[1]['client_address']; ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-1">-->
                                                            <!--                                                        <div class="form-group">-->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="tel" name="phone_j[]" id="phone1" class="form-control" placeholder="01234567890" pattern="[0-9]{11}" value="<?php echo $res_client[1]['client_phone']; ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row count" id="item">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" name="name_j[]" placeholder="name" value="<?php echo $res_client[2]['client_name']; ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-2 hidden">-->
                                                            <!--                                                        -->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="text" step="any" name="address_j[]" id="address1" class="form-control" placeholder="address" value="<?php echo $res_client[2]['client_address']; ?>" required>
                                                                </div>
                                                            </div>
                                                            <!--                                                    <div class="col-md-1">-->
                                                            <!--                                                        <div class="form-group">-->
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input type="tel" name="phone_j[]" id="phone1" class="form-control" placeholder="01234567890" pattern="[0-9]{11}" value="<?php echo $res_client[2]['client_phone']; ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div id="more-items"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="no_float">
                                                <input type="radio" id="" name="member_1" value="not_previous_member" <?php if ($res_1->declaration_option == "not_previous_member") : ?> Checked <?php endif; ?> required>
                                                <label>I have not previously been a member of the Institute</label>
                                                <input type="radio" id="" name="member_1" value="previous_member" <?php if ($res_1->declaration_option == "previous_member") : ?> Checked <?php endif; ?>>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <select name="month_2" class="form-control">
                                                    <option style="font-weight:bold;" value="">month</option>
                                                    <option style="font-weight:bold;" value="january" <?php if ($res_1->dec_from_month == "january") : ?> Selected <?php endif; ?>>january</option>
                                                    <option style="font-weight:bold;" value="february" <?php if ($res_1->dec_from_month == "february") : ?> Selected <?php endif; ?>>february</option>
                                                    <option style="font-weight:bold;" value="march" <?php if ($res_1->dec_from_month == "march") : ?> Selected <?php endif; ?>>march</option>
                                                    <option style="font-weight:bold;" value="april" <?php if ($res_1->dec_from_month == "april") : ?> Selected <?php endif; ?>>april</option>
                                                    <option style="font-weight:bold;" value="may" <?php if ($res_1->dec_from_month == "may") : ?> Selected <?php endif; ?>>may</option>
                                                    <option style="font-weight:bold;" value="june" <?php if ($res_1->dec_from_month == "june") : ?> Selected <?php endif; ?>>june</option>
                                                    <option style="font-weight:bold;" value="july" <?php if ($res_1->dec_from_month == "july") : ?> Selected <?php endif; ?>>july</option>
                                                    <option style="font-weight:bold;" value="august" <?php if ($res_1->dec_from_month == "august") : ?> Selected <?php endif; ?>>august</option>
                                                    <option style="font-weight:bold;" value="september" <?php if ($res_1->dec_from_month == "september") : ?> Selected <?php endif; ?>>september</option>
                                                    <option style="font-weight:bold;" value="october" <?php if ($res_1->dec_from_month == "october") : ?> Selected <?php endif; ?>>october</option>
                                                    <option style="font-weight:bold;" value="november" <?php if ($res_1->dec_from_month == "november") : ?> Selected <?php endif; ?>>november</option>
                                                    <option style="font-weight:bold;" value="december" <?php if ($res_1->dec_from_month == "december") : ?> Selected <?php endif; ?>>december</option>

                                                </select>
                                                <!-- <input class="form-control" type="text" placeholder="month" name="month_2"> -->
                                            </div>
                                            <div class="col-md-2">
                                                <input class="form-control" type="number" placeholder="year" name="year_2" pattern="[0-9]{4}" value="<?php echo $res_1->dec_from_year ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label>To</label>
                                            </div>
                                            <div class="col-md-2 form-group">
                                                <select name="month_3" class="form-control">
                                                    <option style="font-weight:bold;" value="">month</option>
                                                    <option style="font-weight:bold;" value="january" <?php if ($res_1->dec_to_month == "january") : ?> Selected <?php endif; ?>>january</option>
                                                    <option style="font-weight:bold;" value="february" <?php if ($res_1->dec_to_month == "february") : ?> Selected <?php endif; ?>>february</option>
                                                    <option style="font-weight:bold;" value="march" <?php if ($res_1->dec_to_month == "march") : ?> Selected <?php endif; ?>>march</option>
                                                    <option style="font-weight:bold;" value="april" <?php if ($res_1->dec_to_month == "april") : ?> Selected <?php endif; ?>>april</option>
                                                    <option style="font-weight:bold;" value="may" <?php if ($res_1->dec_to_month == "may") : ?> Selected <?php endif; ?>>may</option>
                                                    <option style="font-weight:bold;" value="june" <?php if ($res_1->dec_to_month == "june") : ?> Selected <?php endif; ?>>june</option>
                                                    <option style="font-weight:bold;" value="july" <?php if ($res_1->dec_to_month == "july") : ?> Selected <?php endif; ?>>july</option>
                                                    <option style="font-weight:bold;" value="august" <?php if ($res_1->dec_to_month == "august") : ?> Selected <?php endif; ?>>august</option>
                                                    <option style="font-weight:bold;" value="september" <?php if ($res_1->dec_to_month == "september") : ?> Selected <?php endif; ?>>september</option>
                                                    <option style="font-weight:bold;" value="october" <?php if ($res_1->dec_to_month == "october") : ?> Selected <?php endif; ?>>october</option>
                                                    <option style="font-weight:bold;" value="november" <?php if ($res_1->dec_to_month == "november") : ?> Selected <?php endif; ?>>november</option>
                                                    <option style="font-weight:bold;" value="december" <?php if ($res_1->dec_to_month == "december") : ?> Selected <?php endif; ?>>december</option>

                                                </select>
                                                <!-- <input class="form-control" type="text" placeholder="month" name="month_3"> -->
                                            </div>
                                            <div class="col-md-2">
                                                <input class="form-control" type="number" placeholder="year" name="year_3" pattern="[0-9]{4}" value="<?php echo $res_1->dec_to_year ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <input class="form-control-file app" type="file" name="app_signature" id="app_signature" placeholder="">
                                            ...
                                            <div class="col-md-2">
                                                <input class="form-control" type="date" name="date_3" id="last_date" value="<?php echo $res_1->dec_date ?>" required>
